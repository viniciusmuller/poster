defmodule Poster.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule PosterWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :poster

       ...

       plug PromEx.Plug, prom_ex_module: Poster.PromEx
  ...
  def dashboards do
    [
      ...
      # {:poster, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
